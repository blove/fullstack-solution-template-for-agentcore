...
1. Always read READMEs when you begin working in a new section of the code base before writing any code. For example patterns/<backend.pattern>/frontend/README.md, infra-cdk/README.md and so on.
